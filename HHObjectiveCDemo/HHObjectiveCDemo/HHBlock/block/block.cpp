...
static struct __main0_block_desc_0 {
  size_t reserved;
  size_t Block_size;
} __main0_block_desc_0_DATA = { 0, sizeof(struct __main0_block_impl_0)};
int main0(){

    void(*block)(void) = ((void (*)())&__main0_block_impl_0((void *)__main0_block_func_0, &__main0_block_desc_0_DATA));
