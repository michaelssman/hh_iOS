//
//  HHFMDBViewController.m
//  HHFMDB
//
//  Created by 888888888@qq.com on 07/13/2020.
//  Copyright (c) 2020 888888888@qq.com. All rights reserved.
//

#import "HHFMDBViewController.h"
#import "HHFMDBHeader.h"
#import "CommunityModel.h"
#import "PublishMOdel.h"
#import "FMDBStudent.h"
@interface HHFMDBViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation HHFMDBViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        switch (indexPath.row) {
            case 0: {
                [t createTableWithTableName:tableName dicOrModel:[FMDBStudent class] excludeName:nil db:db];
                break;
            }
            case 1: {
                FMDBStudent *student = [[FMDBStudent alloc]init];
                student.name = @"小黄";
                student.age = @"18";
            ...
            case 2: {
                NSArray *aa = [t selectDatabase:db table:tableName dicOrModel:[FMDBStudent class] whereFormat:nil];
                NSLog(@"%@",aa);
